                                                        ...
                                                        <div class="swiper-wrapper" style="transform: translate3d(0px, 0px, 0px);">
                                                                ...
                                                                <div class="swiper-slide" style="width: 228px; margin-right: 20px;">
                                                                        <div class="item_product_main">
                                                                                <form class="variants product-action" action="" method="post">
                                                                                <div class="product-thumbnail">
                                                                                        <a href="#" class="image_thumb scale_hover" title="Nước Yến sào Sanest lọ 70ml, Hộp 8 lọ" style="height: 196px;">
                                                                                                <img width="480" height="480" src="assets_user/img/untitled-1-17ccc98e-7376-4de9-9e6c-c198004633ef.webp" alt="Tổ yến tinh chế loại 2">
                                                                                        </a>
                                                                                        <span class="smart">- 11%</span>
                                                                                </div>
                                                                                <div class="product-info">
                                                                                        <h3 class="product-name">
                                                                                                <a href="#" title="Nước Yến sào Sanest lọ 70ml, Hộp 8 lọ">Nước Yến sào Sanest lọ 70ml, Hộp 8 lọ</a>
                                                                                        </h3>
                                                                                        <div class="price-box">
                                                                        ...
                                                                        <form class="variants product-action" action="" method="post">
                                                                                <div class="product-thumbnail">
                                                                                        <a href="#" class="image_thumb scale_hover" title="Yến chưng khang phục 2" style="height: 258px;">
                                                                                                <img width="480" height="480" src="assets_user/img/ezgif-f1d528b1-241d-418c-938e-21d5b01f16a8.webp" alt="Yến chưng khang phục 2">
                                                                                        </a>
                                                                                </div>
                                                                                <div class="product-info">
                                                                                        <h3 class="product-name">
                                                                                                <a href="#" title="Yến chưng khang phục 2">Yến chưng khang phục 2</a>
                                                                                        </h3>
                                                                                        <div class="price-box">
